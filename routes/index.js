...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Application App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Application App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Application App Login', user : req.user }); 
}); 
